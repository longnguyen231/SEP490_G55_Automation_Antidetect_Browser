...
const messages = {
  vi: {
    ...
    'cookies.placeholder': 'Dán mảng JSON cookie vào đây (JSON hoặc Netscape format)',
    'cookies.loading': 'Đang tải cookie...',
    'cookies.empty': 'Chưa có cookie',
    'cookies.name': 'Tên',
    'cookies.value': 'Giá trị',
    ...
    'cookies.delete': 'Xóa',
    'cookies.clearAll': 'Xóa tất cả',
    'cookies.clearConfirm': 'Bạn có chắc muốn xóa tất cả cookie?',
    'cookies.search': 'Tìm theo tên hoặc domain...',
    'cookies.edit': 'Sửa',
    'cookies.editTitle': 'Sửa Cookie',
    'cookies.save': 'Lưu',
    'cookies.cancel': 'Hủy',
    'cookies.addNew': 'Thêm mới',
    'cookies.netscapeHint': 'Hỗ trợ JSON array và Netscape/txt format',
    'cookies.imported': 'Đã nhập {count} cookie',
    'cookies.deleted': 'Đã xóa cookie',
    'cookies.cleared': 'Đã xóa tất cả cookie',
  ...
  en: {
    ...
    'cookies.placeholder': 'Paste cookies here (JSON array or Netscape format)',
    ...
    'cookies.clearConfirm': 'Are you sure you want to clear all cookies?',
    'cookies.search': 'Search by name or domain...',
    'cookies.edit': 'Edit',
    'cookies.editTitle': 'Edit Cookie',
    'cookies.save': 'Save',
    'cookies.cancel': 'Cancel',
    'cookies.addNew': 'Add New',
    'cookies.netscapeHint': 'Supports JSON array and Netscape/txt format',
    'cookies.imported': 'Imported {count} cookies',
    'cookies.deleted': 'Cookie deleted',
    'cookies.cleared': 'All cookies cleared',
