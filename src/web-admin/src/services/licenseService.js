...
export const TIER_CONFIG = {
  free: {
    ...
    features: [],
    price: 'Miễn phí',
    description: 'Dùng thử, không cần thanh toán',
    durationOptions: [{ label: '7 ngày', value: 7 }, { label: '30 ngày', value: 30 }],
    defaultDuration: 7,
  ...
  enterprise: {
    label: 'Enterprise',
    maxProfiles: -1,
    features: ['unlimited_profiles', 'automation', 'api_access', 'priority_support', 'custom_integrations', 'white_label'],
    featureLabels: ['Unlimited profiles', 'Browser automation', 'REST API access', 'Priority support', 'Custom integrations', 'White label'],
    price: 'Liên hệ',
    description: 'Cho doanh nghiệp lớn, tùy chỉnh cao',
    durationOptions: [
      { label: '30 ngày', value: 30 },
      { label: '90 ngày', value: 90 },
      { label: '1 năm', value: 365 },
