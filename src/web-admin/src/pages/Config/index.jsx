...
export default function Config() {
  ...
  return (
    <>
      <PageHeader title="Cấu hình hệ thống" description="Giá, maintenance mode, webhook" />
      ...
      <form onSubmit={handleSave} className="max-w-xl space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-xl p-6 space-y-4">
          <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200">Giá Pro License</h3>
          <div>
        ...
        {/* PayOS Webhook (read-only) */}
        <div className="bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-xl p-6 space-y-3">
          <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200">PayOS Webhook URL</h3>
