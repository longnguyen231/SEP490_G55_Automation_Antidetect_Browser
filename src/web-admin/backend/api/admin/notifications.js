    ...
    for (const o of orders) {
      ...
      if (o.status === 'trial') {
        events.push({
          ...
          meta: `30 days · expires ${o.trialExpiresAt ? new Date(o.trialExpiresAt).toLocaleDateString('en-US') : '—'}`,
          time: t,
        ...
        events.push({
          ...
          body: o.userEmail || o.email || 'Unknown',
          meta: `Pro License · ${o.amount ? new Intl.NumberFormat('en-US', { style: 'currency', currency: 'VND' }).format(o.amount) : '—'}`,
          time: t,
          iso: new Date(t).toISOString(),
        });
      }
      ...
      if (data.daily) {
        ...
        if (t >= since) {
          events.push({
            ...
            bg: 'bg-primary/10',
            title: `Download ${label}`,
            body: `${data.count} downloads`,
            meta: data.lastAt ? new Date(data.lastAt).toLocaleDateString('en-US') : '',
            time: t,
            iso: new Date(t).toISOString(),
          });
        }
